...
const 
    ...
    res_start = 5; // Начальная компонента резонанса
    ...
    limit = 10; // Максимально допустимое количество скачков для циркуляции

    INITIAL_ELEMENTS = false; // Записывать ли начальные параметры в файл с классификацией
